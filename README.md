...
못듣더라도 3문제중에 2문제는 맞추자라는 생각으로 끝까지 집중해서 답을 찾았다.
part5 문법은 문법 정리영상이 많이 도움이 되었다. part6는 짧은 문장이었고 난이도는
쉬운편이었다. 170번까지 풀었는데 15분 남았다는 방송이 나왔고(1차멘붕) 180번까지 풀 수
있는 문제만 풀고 냈다.

시험이 끝나고 토익 사이트에 문제 답맞추는 글들이 올라왔고 눈팅을 했는데
내가 헷갈려한 문제들을 사람들이 이게 답이다 저게 답이다하면서 논쟁중이였다.

나는 그것보다 왜 시간이 부족했는 지에 대한 문제점을 파악했다.
오답일거 같은 것들을 소거하고 2개의 선지에서 고민하는 경우가 많았고
오답일 것을 소거한 뒤에도 빈칸에 들어갈 단어에는 어색했던 경우가 있었다.
나는 그때 그 문장에 어떤 단어가 더 말이 되는지에 대한 고민에 시간을 많이 썼다.
그렇게 썼는데도 답은 오답일 것이라 생각한 것이 답이였고..단어 어휘력에 문제가 있었다.
분명 선지의 단어는 모두 알고 있었음에도 occasion 상황, 경우란 단어가 있고
기념품 앞에 쓰이면 기념하다라는 뜻으로 쓰인다는 것을 내가 몰랐기 때문에 틀린 것이었다.

또 영어는 감정표현에 대한 단어가 한글보다 다양하다고 느꼈다. 감정 어휘 picky, dorky 등
주체가 가지고 있는 감정표현 만으로 그 글에 대한 분위기?를 잡아가면서 글을 읽을 수 있게 된다. 또 비교급과 같이 than이 나왔다고해서 무조건 er이 붙은 rather를 답으로 선택한다던지하는 문법 실수를 줄여나가야 한다.

첫 술에 어찌 배부르랴 첫 술에 배부르다면 그건 마약이나 독과 같은 것이다. 오히려 나에게
해가 되었을 것이다. 첫 토익시험이었지만 많은 경험과 도전 과제가 주어졌음에 감사하자
```
## 학교 프로그램
